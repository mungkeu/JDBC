...
public class NoticeConsole {
	...
	public void printNoticeList() throws ClassNotFoundException, SQLException {
		...
		int count = service.getCount(); // 매번 다시 구해야 하므로 지역변수로.
		
		// 매번 다시 구해야 하므로 지역변수로.
		int lastPage = count/10; // 100 -> 10, 90 ->9, 93/10->9 3개가 날라간다.
		lastPage = count%10>0?lastPage+1:lastPage; // 남은 페이지가 있다면 반올림 필요.
